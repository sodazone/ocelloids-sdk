...
import { testContractAddress, testContractBlocks, testContractMetadata } from '@sodazone/ocelloids-sdk-test'
...
describe('Contracts filter operator', () => {
  ...
  describe('filterContractCalls', () => {
    it('should filter contract messages according to criteria provided', () => {
      ...
      const testPipe = filterContractCalls(testAbi, testContractAddress, {
    ...
    it('should work with no callsCriteria passed', () => {
      ...
      const testPipe = filterContractCalls(testAbi, testContractAddress)(from(testContractBlocks))
  ...
  describe('filterContractEvents', () => {
    it('should filter contract events according to criteria provided', () => {
      ...
      const testPipe = filterContractEvents(testAbi, testContractAddress, {
    ...
    it('should work with no eventssCriteria passed', () => {
      ...
      const testPipe = filterContractEvents(testAbi, testContractAddress)(from(testContractBlocks))
